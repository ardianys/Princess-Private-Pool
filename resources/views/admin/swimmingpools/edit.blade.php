...
<div class="container">
    ...
    <div class="card border-0 shadow-sm rounded">
        <div class="card-body">
            <form action="{{ route('admin.swimmingpools.update', $swimmingpool->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
    ...
    <a href="{{ route('admin.swimmingpools.show', $swimmingpool->id) }}" class="btn btn-secondary mt-3">Back to Swimming Pool</a>
</div>
@endsection
