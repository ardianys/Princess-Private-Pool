...
<div class="container text-center">
                            ...
                            <tbody>
                                @foreach ($swimmingpool->allotments as $allotment)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('customer.allotments.show', $allotment) }}" class="btn btn-primary btn-sm">View</a>
                                            {{-- <a href="{{ route('customer.allotments.edit', $allotment) }}" class="btn btn-warning btn-sm">Edit</a>
                                            <form action="{{ route('customer.allotments.destroy', $allotment) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
    ...
    <div class="text-center mt-4">
        <a href="{{ route('customer.swimmingpools.index') }}" class="btn btn-secondary">Back to List</a>
    </div>
</div>
@endsection
