...
<body>
    ...
    <div class="container">
        ...
        @if(Auth::check() && auth()->user()->role === 'admin')
            <div class="mb-5">
                <a href="{{ route('customer.swimmingpools.create') }}" class="btn btn-primary">
                        ...
                        <div class="pool-card-body">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                ...
                                @if(Auth::check() && auth()->user()->role === 'customer')
                                    ...
                                    {{-- <a href="{{ route('customer.swimmingpools.edit', $swimmingpool->id) }}" class="btn btn-primary btn-sm">Edit</a> --}}
                                    {{-- <form action="{{ route('customer.swimmingpools.destroy', $swimmingpool->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
