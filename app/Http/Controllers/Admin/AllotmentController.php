...
class AllotmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.allotments.index')->with('success', 'Allotment successfully added');
    }
    ...
    public function update(Request $request, Allotment $allotment)
    {
        ...
        return redirect()->route('admin.swimmingpools.show',$allotment->swimmingpool_id)->with('success', 'Allotment successfully updated!');
    }
    ...
    public function destroy(Allotment $allotment)
    {
        ...
        return redirect()->route('admin.allotments.index')->with('success', 'Allotment, delete success!');
    }
}
