...
{  
    ...
    {  
        ...
        return view('admin.swimmingpools.index', compact('swimmingpools'));  
    }  

    // Menampilkan form untuk membuat kolam renang  
    public function create(): View  
    {  
        return view('admin.swimmingpools.create');  
    }  
    ...
    {  
        ...
        return redirect()->route('admin.swimmingpools.index')->with('success', 'Swimming pool created successfully!');  
    }  
    ...
    {  
        ...
        return view('admin.swimmingpools.show', compact('swimmingpool'));  
    }  
    ...
    {  
        ...
        return view('admin.swimmingpools.edit', compact('swimmingpool'));  
    }  
    ...
    {  
        ...
        return redirect()->route('admin.swimmingpools.index')->with('success', 'Swimming pool updated successfully!');  
    }  
    ...
    {  
        ...
        return redirect()->route('admin.swimmingpools.index')->with('success', 'Swimming pool deleted successfully!');  
    }  
}